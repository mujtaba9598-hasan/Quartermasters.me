...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!apiKey) {
      ...
      return NextResponse.json(
        { error: "Email service is not configured. Please contact us directly at info@quartermasters.me." },
        { status: 503 },
      );
    }
    ...
    const toEmail = process.env.CONTACT_EMAIL ?? "info@quartermasters.me";

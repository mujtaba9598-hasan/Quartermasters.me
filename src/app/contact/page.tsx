...
export default function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(
        "Unable to reach our servers. Please check your connection and try again, or contact us directly at info@quartermasters.me."
      );
    } finally {
      setSubmitting(false);
    }

      ...
      <>
        ...
        <ul className="list-disc pl-6 space-y-1 mt-2">
          ...
          <li>
            ...
            <strong>info@quartermasters.me</strong>.
          </li>
        </ul>
        <p className="mt-3">
      ...
      <>
        ...
        <ul className="list-disc pl-6 space-y-1 mt-2">
          <li>
            ...
            <strong>info@quartermasters.me</strong> within fourteen (14) days
            of the payment date.
          </li>
          <li>
    ...
    content: (
      <>
        ...
        <p className="mt-3">
          ...
          contacting us at <strong>info@quartermasters.me</strong>.
        </p>
        <p className="mt-3">

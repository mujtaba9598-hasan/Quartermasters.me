  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-32">
        ...
        >
          {/* Overline */}
          <motion.p variants={staggerItem} className="text-overline mb-6">
            Ajman Free Zone Licensed Consultancy
          </motion.p>
          ...
          >
            ...
            <span style={{ color: "var(--color-accent-gold)" }}>Capital</span>,{" "}
            <span style={{ color: "var(--sector-hr-teal)" }}>Talent</span>, and{" "}
            <span style={{ color: "var(--sector-events-lime)" }}>Logistics</span>.
          </motion.h1>

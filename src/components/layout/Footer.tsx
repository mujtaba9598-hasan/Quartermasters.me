        ...
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
            ...
            <div className="md:col-span-2">
              ...
              >
                Strategic orchestration for Capital, Talent, and Logistics.
              ...
              <div className="mt-6 flex gap-3">
                ...
                <span className="pill-tag pill-tag--events">#Logistics</span>
              </div>
            </div>
          ...
          >
            <div>
              ...
              <p
                ...
                style={{ color: "var(--color-text-dim)" }}
              >
                Ajman Free Zone, C1 Building, Office SF2097
              </p>
            </div>
            <div className="text-right">
              <p
                ...
                style={{ color: "var(--color-text-dim)" }}
              >
                Regulated by AFZA &middot; License No: 37357
              </p>
              <p
